...
-- transfere a propriedade do schema
ALTER SCHEMA ms_cliente OWNER TO springuser;
ALTER SCHEMA ms_conta_cud OWNER TO springuser;
ALTER SCHEMA ms_conta_r OWNER TO springuser;
ALTER SCHEMA ms_gerente OWNER TO springuser;
